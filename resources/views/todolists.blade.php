                    ...
                    <div class="row justify-content-around">
                    	...
                    	<div class="col-md-3">
                    		<div class="card mb-3">
								...
								<button type="button" class="btn btn-outline-secondary btn-sm mx-2 mt-1" data-toggle="modal" data-target="#exampleModal{{ $todolist->id }}">Modifier</button>

								<!-- Modal -->
								<div class="modal fade" id="exampleModal{{ $todolist->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
